...
- (UIImageView *)selectedImageView {
    if (!_selectedImageView) {
        // 选择区域图标
//        _selectedImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0 ,self.frame.size.width, self.frame.size.height)];
...
- (UIButton *)selectedButton {
    if (!_selectedButton) {
        ...
        _selectedButton.frame = CGRectMake(0, 0 ,self.frame.size.width, self.frame.size.height);
